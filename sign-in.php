...
if ($result && $result->num_rows > 0) {
    ...
    $errors[] = "Error fetching role data from database";
                                ...
                                <div class="m-sm-3">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="email" name="email" id="emailField" required placeholder="Enter your Email"/>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Password</label>
                                            <input class="form-control form-control-lg" type="password" name="password" id="passwordField" required  placeholder="Enter your password" />
                                        </div>
